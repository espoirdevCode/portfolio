                                ...
                                <div>
                                    <ul className='mt-6 flex flex-wrap gap-x-10 gap-y-6 items-center'>
                                        ...
                                        <li className='flex items-center gap-x-3'>
                                            ...
                                            <p>theLeaderOfCommunity@gmail.com</p>
                                        </li>
                                        <li className='flex items-center gap-x-3'>
                                            <div className='flex-none text-base-content'>
                                                <Map/>
                            ...
                            <div className='flex-1 mt-12 sm:max-w-lg lg:max-w-md'>
                                <form className='space-y-5'>
                                    <div className=" flex flex-col  md:flex-row gap-3">
                                        <input className=" p-2 px-5 border-b border-blue-500 text-sm bg-transparent " type="text" placeholder="Entrez votre nom complet"/>
                                        <input className=" p-2 px-5 border-b border-blue-500 text-sm bg-transparent " type="email" placeholder="Entrez votre email complet"/>
                                      
                                    </div>
                                    <div>
                                        <textarea id='message' placeholder="Entrez un message" required className=' p-2 px-5 border rounded-xl border-blue-500 text-sm bg-transparent w-full h-32 md:h-60' ></textarea>
                                    </div>
