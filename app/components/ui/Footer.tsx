        ...
        <Card className=' bg-background'>
            <footer className=''>
                <div className='max-w-screen-xl mx-auto px-4 md:px-8'>
                    <div className='justify-between items-start gap-8 md:flex'>
                        <div className='flex-1'>
                            <div className=' mt-10  flex-1 space-y-6 justify-between sm:flex md:space-y-0'>
                                ...
                                <ul className='space-y-3 text-base-content'>
                                    <Logo />
                                    <br />
                                    <h4 className='text-base-content'>11 Rue, Mfilou</h4>
                                    <h4 className='text-base-content'>Congo, Brazzaville</h4>
                                    <br />
                                    { /*-use a map loop*/}
                                    <li>
                                ...
                                <ul className='space-y-3 text-base-content'>
                                    <h2 className=' text-2xl font-bold'>Liens utilisés</h2>
                                    <br />
                                    <li> Accueil</li>
                                    <li>Nos Services</li>
                                    <li>Page de Blog</li>
                        ...
                        <div className='flex-1 mt-5 justify-start items-start flex-col max-w-96'>
                            <div className=' md:p-5 space-y-5'>
                                <h1 className=' text-2xl font-bold'>Rejoignez ma newsletter</h1>
                                <p>pour ne rien ratez de mes publications aboonés vous à ma newsletter </p>
                            </div>
                    ...
                    <div className='mt-10 py-10 border-t items-center justify-center sm:flex'>
                        <div>
                            ...
                            <p className=' text-center'>
                                Editer par <span className=' text-blue-500'>EspoirDev</span>
                            </p>
                        </div>
